			...
			"update": function() {
				...
				if (l == "Random") {
					...
					if (c === 0) {
						...
						$('#videos').append("<video id='bg-multiplayer' src='"+d+"halo3/multiplayer.webm' loop autoplay type='video/webm'></video>");
						$('#videos').append("<video id='bg-forge' src='"+d+"halo3/forge.webm' loop autoplay type='video/webm'></video>");
					} else if (c === 11) {
